        ...
        <div className="hero-content text-center">
          <div>
            <p className="text-2xl font-bold text-green-900">
              Welcome to <span className="text-red-900">Weather App</span>{" "}
            </p>
            <p className="mb-4">
              Choose a location to see the weather forecast
            </p>
            <input
              className="input text-2xl input-bordered input-primary w-full max-w-xs mt-1"
              type="text"
            ...
            />
            <button
              className="btn btn-outline bg-red-900 text-white m-3"
              onClick={() => refetch()}
            >
              SEARCH
            </button>
            <button
              className="btn btn-outline bg-green-900 text-white m-3"
              onClick={() => {
        ...
        <div className="hero-content text-center">
          <div>
            ...
            <div className="flex items-center justify-center mb-4">
              {" "}
              {/* flex kullanarak hizalama */}
              <input
                className="input text-2xl input-bordered input-primary w-2/3 max-w-xs"
                type="text"
                placeholder="Search location"
                value={location}
                onChange={handeLocationChange}
